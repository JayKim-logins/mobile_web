  ...
  return (
    <section id="service01" direction="row" className={serviceStyle.wrap} >
        ...
        <div className={serviceStyle.contents_container}>
            ...
            <div className={serviceStyle.button}>
                <div >실시간 견적조회</div>
                <span style={{height: "1.5rem"}} >
                    <canvas width="24" height="24" style={{width: "1.5rem"}}></canvas>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8.59 16.59L13.17 12L8.59 7.41L10 6L16 12L10 18L8.59 16.59Z" fill="rgb(84, 130, 214)"></path>
                    </svg>
                </span>
            </div>
        </div>
